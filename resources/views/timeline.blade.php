                    ...
                    @auth
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="trigger">
                                ...
                                <button class=" pr-4 flex items-center text-sm font-medium text-black-500 hover:text-black hover:border-black-300 focus:outline-none focus:text-black-700 focus:border-gray-300 transition duration-150 ease-in-out">
...
<section class="relative flex flex-wrap bg-gray-100">
    <div
    ...
    <div class=" w-full px-4 py-12  lg:w-1/2 sm:px-6 lg:px-8 sm:py-16 lg:py-4 lg:h-screen lg:items-center overflow-y-scroll">
        <livewire:posts>
