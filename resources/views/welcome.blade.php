        ...
        <div class="px-4 mx-auto sm:pr-0 max-w-screen-2xl">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="items-center justify-end hidden space-x-8 sm:flex bg-yellow-500">
                    ...
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url("/dashboard/{$user->id}") }}" class="inline-flex items-center h-16 px-12 text-xs font-bold tracking-widest text-black-900 uppercase bg-yellow-500">Mon Compte</a>
        ...
        <div class="w-1/2 mx-auto">
            <div class="w-full shadow-2xl subpixel-antialiased rounded h-64 bg-black border-black mx-auto">
                ...
                <div class="pl-1 pt-1 h-auto  text-green-200 font-mono text-xs bg-black" id="console">
                    ...
                    <textarea id="text-input-textarea typewriter" class="pb-1 bg-black border-black border-transparent focus:border-transparent focus:ring-0 focus:outline-none" cols="70" rows="8" placeholder="">Kong: est une plateforme digitale professionnelle privée qui a pour but d'améliorer les relations, l’engagement, la collaboration et la productivité des collaborateurs. Nous croyons à un monde plus connecté, dans lequel tout le monde peut discuter et collaborer à distance.</textarea>
                </div>
            </div>
        </div>
    </div>
